"""seu_luis_barbearia_19784 URL Configuration
...
admin.site.site_header = "Seu Luis Barbearia"
admin.site.site_title = "Seu Luis Barbearia Admin Portal"
admin.site.index_title = "Seu Luis Barbearia Admin"

# swagger
api_info = openapi.Info(
    title="Seu Luis Barbearia API",
    default_version="v1",
    description="API documentation for Seu Luis Barbearia App",
)
